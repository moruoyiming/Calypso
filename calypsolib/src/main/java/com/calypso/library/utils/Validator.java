...
public class Validator {
    ...
    /**
     * 正则表达式：验证密码    密码有6-16位,由字母a-z,A-Z,数字0-9组成
     */
     ...
     * 正则表达式：验证手机号
     */
//    public static final String REGEX_MOBILE = "^((13[0-9])|(15[^4,\\D])|(18[\\d])|(17[0678]))\\d{8}$";

    public static final String REGEX_MOBILE = "^1[3578]\\d{9}$";

//    public static final String REGEX_MOBILE1 = "((13\\d{9}|14[57])|(15[012356789])|(18[01256789])|(17[0678]))\\d{8}";
