package com.calypso.library.view.FlycoTabLayout;
...
import com.calypso.library.view.FlycoTabLayout.listener.CustomTabEntity;
...
public class CommonTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mTitleVisible=ta.getBoolean(R.styleable.CommonTabLayout_tl_textVisible, true);
